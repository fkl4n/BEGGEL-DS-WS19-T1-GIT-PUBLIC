...
Zu Beginn betrachten wir das Farbschema für die nachfolgenden Diagramme. Das Schema ist einheitlich zur besseren Verständlichkeit der Diagramme:
...
# db_git_history = load_db_history2("../../Workspace/MongoDB.csv")
...
## Stacked bar graph database language percentage over multiple languages

## Histogram: changes in repo language distribution over time

## Multiline Plot: development language over time 
