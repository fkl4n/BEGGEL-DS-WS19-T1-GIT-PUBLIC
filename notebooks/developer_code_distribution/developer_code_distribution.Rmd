...
plot_pie_chart_developer = function(name, db_git_history, threshold, title){
  tmp = aggregate(db_git_history$change, by = list(author = db_git_history$authorName, programmingLanguage = db_git_history$programmingLanguage), FUN = sum)
 ...
 rank_developer = aggregate(db_git_history[, c("change"), drop=FALSE], by = list(author = db_git_history$authorName, commit = db_git_history$commit), FUN = sum)
